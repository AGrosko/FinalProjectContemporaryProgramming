...
namespace FinalProject.Controllers
{
    ...
    public class GradesController : ControllerBase
    {
        ...
        private readonly IGradesContextDOA _context;

        public GradesController(ILogger<GradesController> logger, IGradesContextDOA context)
        {
            _logger = logger;
            _context = context;
        }
        ...
        [HttpPut]
        public IActionResult PutById(Grades info)
        {
        ...
        [HttpPost]
        public IActionResult Post(Grades info)
        {
